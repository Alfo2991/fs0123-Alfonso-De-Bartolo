...
while (i < starWarsCharacters.length) {
  ...
  total += Number(starWarsCharacters[i].mass);
  i++;
}
console.log(total)
...
starWarsCharacters.forEach(function (starWarsCharacters) {
  if (starWarsCharacters.gender == "n/a") {
    starWarsCharacters.gender = starWarsCharacters.gender.replace("n/a", "robot");
